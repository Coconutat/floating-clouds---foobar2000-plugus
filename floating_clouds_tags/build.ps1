<#
.SYNOPSIS
    Builds the foo_floating_clouds_tags foobar2000 component (Apple Music Tags).
...
.DESCRIPTION
    ...
    - -Package builds an installable foo_floating_clouds_tags.fb2k-component
      under .\dist.
...
.PARAMETER Package
    ...
    foo_floating_clouds_tags.fb2k-component file under .\dist.
...
$ProjectFile = Join-Path $WorkspaceRoot 'floating_clouds_tags.vcxproj'
...
Write-Host "== Apple Music Tags build ==" -ForegroundColor Cyan
